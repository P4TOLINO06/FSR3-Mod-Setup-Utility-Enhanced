namespace FSR3ModSetupUtilityEnhanced
{
    partial class formHome
    {
        ...
        private void InitializeComponent()
        {
            ...
            listGames.Items.AddRange(new object[] { "Select FSR Version", "A Plague Tale Requiem", "Achilles Legends Untold", "Alan Wake 2", "Alone in the Dark", "Assassin's Creed Mirage", "Assassin's Creed Valhalla", "Atomic Heart", "Banishers: Ghosts of New Eden", "Black Myth: Wukong", "Blacktail", "Baldur's Gate 3", "Bright Memory: Infinite", "Brothers: A Tale of Two Sons Remake", "Chernobylite", "Cod Black Ops Cold War", "Cod MW3", "Control", "Crime Boss: Rockay City", "Cyberpunk 2077", "Dakar Desert Rally", "Dead Island 2", "Dead Space (2023)", "Death Stranding Director's Cut", "Deathloop", "Dragons Dogma 2", "Dying Light 2", "Elden Ring", "Everspace 2", "Evil West", "Final Fantasy XVI", "F1 2022", "F1 2023", "FIST: Forged In Shadow Torch", "Flintlock: The Siege Of Dawn", "Fort Solis", "Forza Horizon 5", "GTA V", "Ghostrunner 2", "Ghostwire: Tokyo", "Ghost of Tsushima", "God Of War 4", "Hellblade: Senua's Sacrifice", "Hellblade 2", "High On Life", "Hitman 3", "Horizon Forbidden West", "Horizon Zero Dawn", "Hogwarts Legacy", "Icarus", "Judgment", "Jusant", "Kena: Bridge of Spirits", "Layers of Fear", "Lies of P", "Lords of the Fallen", "Loopmancer", "Manor Lords", "Martha Is Dead", "Marvel's Guardians of the Galaxy", "Marvel's Spider-Man Miles Morales", "Marvel's Spider-Man Remastered", "Metro Exodus Enhanced Edition", "MOTO GP 24", "Monster Hunter Rise", "Nightingale", "Nobody Wants To Die", "Outpost: Infinity Siege", "Pacific Drive", "Palworld", "Ratchet & Clank - Rift Apart", "Ready or Not", "Red Dead Redemption 2", "Remnant II", "Returnal", "Ripout", "RoboCop: Rogue City", "Saints Row", "Sackboy: A Big Adventure", "Satisfactory", "Shadow Warrior 3", "Shadow of the Tomb Raider", "Smalland", "STAR WARS Jedi: Survivor", "Star Wars Outlaws", "Steelrising", "STARFIELD", "TEKKEN 8", "The Callisto Protocol", "The Chant", "The Casting Of Frank Stone", "The Invincible", "The Last of Us Part I", "The Medium", "The Outer Worlds: Spacer's Choice Edition", "The Thaumaturge", "The Witcher 3", "Uncharted Legacy of Thieves Collection", "Wanted: Dead", "Warhammer: Space Marine 2" });
