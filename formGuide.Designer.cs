namespace FSR3ModSetupUtilityEnhanced
{
    partial class formGuide
    {
        ...
        private void InitializeComponent()
        {
            ...
            listBox1.Items.AddRange(new object[] { "Initial Information", "Add-on Mods", "Optiscaler Method", "Optiscaler FSR 3.1/DLSS", "Achilles Legends Untold", "Alan Wake 2", "Alone in the Dark", "A Plague Tale Requiem", "Assassin's Creed Valhalla", "Atomic Heart", "Baldur's Gate 3", "Black Myth: Wukong", "Blacktail", "Banishers Ghost of New Eden", "Bright Memory: Infinite", "Brothers a Tale of Two Sons", "Chernobylite", "Cod Black Ops Cold War", "Cod MW3", "Control", "Crime Boss Rockay City", "Cyberpunk 2077", "Dakar Desert Rally", "Dead Space Remake", "Dead Island 2", "Death Stranding Director's Cut", "Deathloop", "Dragons Dogma 2", "Dying Light 2", "Elden Ring", "Everspace 2", "Evil West", "Fist Forged in Shadow Torch", "Flintlock: The Siege of Dawn", "Fort Solis", "Forza Horizon 5", "Final Fantasy XVI", "F1 2022", "F1 2023", "GTA V", "Ghost of Tsushima", "Ghostrunner 2", "Ghostwire: Tokyo", "God Of War 4", "Hellblade: Senua's Sacrifice", "Hellblade 2", "High On Life", "Hitman 3", "Hogwarts Legacy", "Horizon Forbidden West", "Icarus", "Judgment", "Jusant", "Kena: Bridge of Spirits", "Layers of Fear", "Lies of P", "Loopmancer", "Lords of the Fallen", "Manor Lords", "Martha Is Dead", "Marvel's Guardians of the Galaxy", "Metro Exodus Enhanced", "Monster Hunter Rise", "Nobody Wants To Die", "Outpost Infinity Siege", "Pacific Drive", "Palworld", "Ratchet and Clank", "Rise of The Tomb Raider", "Ready or Not", "Red Dead Redemption 2", "Red Dead Redemption 2 MIX", "Red Dead Redemption Mix 2", "Red Dead Redemption V2", "RDR2 Non Steam", "Returnal", "Ripout", "Saints Row", "Sackboy: A Big Adventure", "Shadow of the Tomb Raider", "Shadow Warrior 3", "Smalland", "Star Wars Jedi: Survivor", "Star Wars Outlaws", "The Callisto Protocol", "The Casting Of Frank Stone", "Warhammer: Space Marine 2" });
