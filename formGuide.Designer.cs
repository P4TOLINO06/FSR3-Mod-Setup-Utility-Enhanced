namespace FSR3ModSetupUtilityEnhanced
{
    partial class formGuide
    {
        ...
        private void InitializeComponent()
        {
            ...
            webView21.Size = new Size(130, 40);
            ...
            buttonVideo.Location = new Point(1601, 0);
            ...
            listBox1.Items.AddRange(new object[] { "Initial Information", "Add-on Mods", "Optiscaler Method", "Optiscaler FSR 3.1.1/DLSS", "Optiscaler FSR 3.1.3/DLSS (Only Optiscaler)", "Achilles Legends Untold", "Alan Wake Remastered", "Alan Wake 2", "Alone in the Dark", "A Plague Tale Requiem", "A Quiet Place: The Road Ahead", "Assassin's Creed Mirage", "Assassin's Creed Valhalla", "Assetto Corsa Evo", "Atomic Heart", "AVOWED", "Back 4 Blood", "Baldur's Gate 3", "Black Myth: Wukong", "Blacktail", "Banishers Ghost of New Eden", "Bright Memory", "Bright Memory: Infinite", "Brothers: A Tale of Two Sons Remake", "Chernobylite", "Chernobylite 2: Exclusion Zone", "Choo-Choo Charles", "Chorus", "Cities: Skylines 2", "Cod Black Ops Cold War", "Cod MW3", "Control", "Crime Boss Rockay City", "Crysis Remastered", "Cyberpunk 2077", "Dakar Desert Rally", "Dead Space Remake", "Dead Island 2", "Dead Rising Remaster", "Death Stranding Director's Cut", "Deathloop", "Deliver Us Mars", "Deliver Us The Moon", "Dragon Age: Veilguard", "Dragons Dogma 2", "Dying Light 2", "Dynasty Warriors: Origins", "Elden Ring", "Empire of the Ants", "Everspace 2", "Evil West", "Eternal Strands", "Fist Forged in Shadow Torch", "Flintlock: The Siege of Dawn", "Fobia – St. Dinfna Hotel", "Fort Solis", "Forza Horizon 5", "Final Fantasy VII Rebirth", "Final Fantasy XVI", "Five Nights at Freddy’s: Security Breach", "Frostpunk 2", "F1 2022", "F1 2023", "Ghost of Tsushima", "Ghostrunner 2", "Ghostwire: Tokyo", "God Of War 4", "God of War Ragnarök", "Gotham Knights", "GreedFall II: The Dying World", "GTA Trilogy", "GTA V", "Hellblade: Senua's Sacrifice", "Hellblade 2", "High On Life", "Hitman 3", "Hogwarts Legacy", "Horizon Forbidden West", "Horizon Zero Dawn\\Remastered", "Hot Wheels Unleashed", "Icarus", "Indiana Jones and the Great Circle", "Judgment", "Jusant", "Kingdom Come: Deliverance II", "Kena: Bridge of Spirits", "Layers of Fear", "Lies of P", "Like a Dragon: Pirate Yakuza in Hawaii", "Lego Horizon Adventures", "Loopmancer", "Lords of the Fallen", "Lost Records Bloom And Rage", "Manor Lords", "Martha Is Dead", "Marvel's Avengers", "Marvel's Guardians of the Galaxy", "Marvel's Midnight Suns", "Metro Exodus Enhanced", "Microsoft Flight Simulator 24", "Monster Hunter Rise", "Monster Hunter Wilds", "Mortal Shell", "Ninja Gaiden 2 Black", "Nobody Wants To Die", "Orcs Must Die! Deathtrap", "Outpost Infinity Siege", "Pacific Drive", "Palworld", "Path of Exile II", "Ratchet and Clank", "Rise of The Tomb Raider", "Ready or Not", "Red Dead Redemption", "Red Dead Redemption 2", "Remnant II", "Resident Evil 4 Remake", "Returnal", "Ripout", "Saints Row", "Sackboy: A Big Adventure", "Scorn", "Sengoku Dynasty", "Shadow of the Tomb Raider", "Shadow Warrior 3", "Sifu", "Silent Hill 2", "Six Days in Fallujah", "Smalland", "Spider Man/Miles", "S.T.A.L.K.E.R. 2", "Star Wars Jedi: Survivor", "Star Wars Outlaws", "Steelrising", "Soulslinger Envoy of Death", "Soulstice", "Suicide Squad: Kill the Justice League", "Test Drive Unlimited Solar Crown", "The Ascent", "The Callisto Protocol", "The Casting Of Frank Stone", "The First Berserker: Khazan", "The Last Of Us", "The Talos Principle 2", "The Witcher 3", "Thymesia", "Uncharted Legacy Of Thieves", "Unknown 9: Awakening", "Until Dawn", "Warhammer: Space Marine 2", "Wanted Dead", "Watch Dogs Legion", "Way Of The Hunter", "Wayfinder", "WILD HEARTS" });
